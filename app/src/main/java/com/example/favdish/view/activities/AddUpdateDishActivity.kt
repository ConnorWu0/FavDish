    ...
    override fun onClick(v: View?) {
        if (v != null){
            when(v.id){
                ...
                R.id.et_type -> {
                    customItemsListDialog(getString(R.string.title_select_dish_type),
                    Constants.dishTypes(),Constants.DISH_TYPE)
                    return
                }
                R.id.et_category -> {
                    customItemsListDialog(getString(R.string.title_select_dish_category),
                        Constants.dishCategories(),Constants.DISH_CATEGORY)
                    return
                }
                R.id.et_cooking_time -> {
                    customItemsListDialog(getString(R.string.title_select_dish_cooking_time),
                    ...
                    when {
                        ...
                        TextUtils.isEmpty(cookingDirection) -> {
                            ...
                            Log.i("Insertion","Success")
                                ...
                                Toast.makeText(this,"You successfully updated your favorite dish details.",
                                    Toast.LENGTH_LONG).show()
